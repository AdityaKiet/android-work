...
public class AlertDialogActivity {
	...
	public static void alertDialogDisplay(AlertDialogDTO alertDialogDTO,
			final IAlertLogic iAlertLogic) {
		AlertDialog.Builder builder = new AlertDialog.Builder(
				alertDialogDTO.getContext());
		...
		if (null != alertDialogDTO.getPositiveButon()) {
			if (null == iAlertLogic)
				builder.setPositiveButton(alertDialogDTO.getPositiveButon(),
						null);
			else {
				builder.setPositiveButton(alertDialogDTO.getPositiveButon(),
		...
		if (null != alertDialogDTO.getNegativeButton()) {
			if (null == iAlertLogic)
				builder.setNegativeButton(alertDialogDTO.getNegativeButton(),
						null);
			else {
				builder.setNegativeButton(alertDialogDTO.getNegativeButton(),
						new DialogInterface.OnClickListener() {
